package org.codeset.gear.select;

import org.codeset.gear.helper.Validate;
import org.codeset.gear.nodes.Comment;
import org.codeset.gear.nodes.Document;
import org.codeset.gear.nodes.DocumentType;
import org.codeset.gear.nodes.Element;
import org.codeset.gear.nodes.Node;
import org.codeset.gear.nodes.XmlDeclaration;
...
public abstract class Evaluator {
    ...
    public static final class AttributeStarting extends Evaluator {
        ...
        @Override
        public boolean matches(Element root, Element element) {
            List<org.codeset.gear.nodes.Attribute> values = element.attributes().asList();
            for (org.codeset.gear.nodes.Attribute attribute : values) {
